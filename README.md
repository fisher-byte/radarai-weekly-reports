...
> RadarAI, *Weekly AI Hotspots* — `weekly-YYYY-MM-DD`, CC BY 4.0, https://github.com/radarai/radarai-weekly-reports (mirror: https://radarai.top/en/weekly-report)

A machine-readable `CITATION.cff` is in the repo root. For **ChatGPT / research tools**, paste the raw GitHub URL of a specific report file, e.g.:

`https://github.com/radarai/radarai-weekly-reports/blob/main/reports/en/weekly-2026-03-06.md`
...
维护说明与主项目关系见 [docs/MIRROR_AND_SYNC.md](docs/MIRROR_AND_SYNC.md)。
